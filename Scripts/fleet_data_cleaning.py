...
complete_park = os.path.join(path,"Exact_fleet","mat_2023.txt")
clean_park = os.path.join(path,"Exact_fleet","clean_park.csv")
               
parque = pl.scan_csv(complete_park, separator='|', schema=types_fleet_original)
