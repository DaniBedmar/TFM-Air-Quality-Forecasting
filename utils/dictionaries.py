...
common_cols_parque_exacto = ["FECHA_MATR", "FECHA_PRIM_MATR", "CLASE_MATR", "MARCA", "MODELO", "PROCEDENCIA",
    "TIPO", "TIPO_DGT", "PROPULSION", "CILINDRADA", "POTENCIA", "KW", "TARA",
    "PESO_MAX", "MOM", "MMTA", "PLAZAS", "PLAZAS_MAX", "PLAZAS_PIE", "NUM_TITULARES",
    "PROVINCIA", "MUNICIPIO", "PROVINCIA_MATR", "NUEVO_USADO", "TIPO_TITULAR",
    "SERVICIO", "EMISIONES_CO2", "RENTING", "VARIANTE", "VERSION", "FABRICANTE",
    "CARROCERIA", "DISTANCIA_EJES", "EJE_ANTERIOR", "EJE_POSTERIOR", "EMISIONES_EURO",
    "CONSUMO", "AUTONOMIA", "ALIMENTACION", "CATELECT"]

common_cols_tramites = ["FEC_MATRICULA", "FEC_PRIM_MATRICULACION", "COD_CLASE_MAT", "MARCA_ITV", "MODELO_ITV",
    ...
    "VARIANTE_ITV", "VERSION_ITV",
    "FABRICANTE_ITV", "CARROCERIA", "DISTANCIA_EJES_12_ITV",
